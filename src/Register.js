        ...
        <div className="full-page">
            <div id="login-page">
               ...
               <form id ='register' className="input">
                <input type='text' className="in-field" placeholder="First Name" required/><br/><br/>
                <input type='text' className="in-field" placeholder="Last Name" required/><br/><br/>
                ...
                <input type='password' className="in-field" placeholder="Confirm Password" required/><br/><br/>
